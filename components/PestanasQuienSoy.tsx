...
export default function PestanasQuienSoy() {
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <section hidden={activa !== "corta"} role="tabpanel" id="panel-corta" aria-labelledby="tab-corta" className="flex flex-col gap-6">
      ...
      <section hidden={activa !== "larga"} role="tabpanel" id="panel-larga" aria-labelledby="tab-larga" className="flex flex-col gap-8">
      ...
      <section hidden={activa !== "prensa"} role="tabpanel" id="panel-prensa" aria-labelledby="tab-prensa" className="flex flex-col gap-8">
